...
import static de.gtarc.chariot.registrationapi.client.util.ClientUtils.createUpdate;


/***
 * This class is used for Device Update, this is an implementation of a Callable and ConnectionListener interfaces.
 * @author cemakpolat
 */
public class RunnerEntityUpdate implements Callable<ClientResult>, ConnectionListener {
    ...
    public RunnerEntityUpdate(Connection conn, Entity entity, String reId, String securityKey) {
        this.entity = entity;
        this.reId = reId;
    ...
    public ClientResult call() throws InterruptedException, ConnectionException {
        AbstractMessage message = createUpdate("", TopicConfig.getUpdateTopic(),
                TopicConfig.getUpdateResponseTopic(this.entity.getUUIdentifier().toString()),
                "client", "server", reId, this.entity.getUUIdentifier().toString(), securityKey, this.entity);
